...
public class PsiFieldsModifierTest {
    ...
    public void shouldAddFieldsOfCopyToBuilderClassWithoutAnnotationAndFinalModifierAndComments() {
        ...
        given(psiModifierListForConstructor.hasExplicitModifier(PsiFieldsModifier.FINAL)).willReturn(true);
        ...
        verify(psiModifierListForConstructor).setModifierProperty(PsiFieldsModifier.FINAL, false);
